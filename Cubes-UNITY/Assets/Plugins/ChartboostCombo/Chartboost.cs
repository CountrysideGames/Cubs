...
public class Chartboost
{
	...
	static Chartboost()
	{
		...
		Manager.didFailToCacheMoreAppsEvent += ( location ) => { didFailToCacheMoreAppsEvent.fire( location ); };
		...
		Manager.didFailToLoadRewardedVideoEvent += ( location ) => { didFailToLoadRewardedVideoEvent.fire( location ); };
